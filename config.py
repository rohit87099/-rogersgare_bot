...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6744570758:AAEKlYipGDT9BVcLNq7t8QsxXSEd2InnU-c")
...
PROTECT_CONTENT = True if os.environ.get('FALSE', "False") == "False" else False
